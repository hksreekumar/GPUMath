...
int main(int argc, char **argv) 
{
  ...
  CHKERRQ(ierr);
   ...
   //MatCreateAIJ - for CPU

  ierr = MatCreateDense(PETSC_COMM_WORLD, PETSC_DECIDE, PETSC_DECIDE,m,n, NULL, &A);
  ierr = MatCreateDense(PETSC_COMM_WORLD, PETSC_DECIDE, PETSC_DECIDE,m,n, NULL, &B);
  ierr = MatCreateDense(PETSC_COMM_WORLD, PETSC_DECIDE, PETSC_DECIDE,m,n, NULL, &C);
