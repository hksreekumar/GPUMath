...
int main(int argc, char **argv) 
{
    ...
    readMatrixFromFile(m_K, "../data/dense/Plate_50K/PlateMat_K.mat");
    ...
    readMatrixFromFile(m_M, "../data/dense/Plate_50K/PlateMat_M.mat");
    ...
    readMatrixFromFile(m_D, "../data/dense/Plate_50K/PlateMat_D.mat");
    ...
    readMatrixFromFile(m_B, "../data/dense/Plate_50K/PlateMat_B.mat");
    ...
    readMatrixFromFile(m_C, "../data/dense/Plate_50K/PlateMat_C.mat");
