...
int main(int argc, char **argv) 
{
  ...
  // Create a parallel sparse matrix - GPU
  // MatCreateAIJCUSPARSE(PETSC_COMM_WORLD, localRows, localCol, gLobalRow, globalCol, 0, NULL, 0, NULL, &A);
  ierr = MatCreateAIJCUSPARSE(PETSC_COMM_WORLD, PETSC_DECIDE, PETSC_DECIDE, m, n, 0, NULL, 0, NULL, &A);
  ierr = MatCreateAIJCUSPARSE(PETSC_COMM_WORLD, PETSC_DECIDE, PETSC_DECIDE, m, n, 0, NULL, 0, NULL, &B);
  ierr = MatCreateAIJCUSPARSE(PETSC_COMM_WORLD, PETSC_DECIDE, PETSC_DECIDE, m, n, 0, NULL, 0, NULL, &C);
