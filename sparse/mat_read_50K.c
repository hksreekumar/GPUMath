...
int main(int argc, char **argv) 
{
    ...
    readVectorFromFile(m_F, "../data/sparse/Plate_50K/PlateVec_F.mat");
    ...
    readMatrixFromFile(m_K, "../data/sparse/Plate_50K/PlateMat_K.mat");
    ...
    readMatrixFromFile(m_M, "../data/sparse/Plate_50K/PlateMat_M.mat");
    ...
    readMatrixFromFile(m_D, "../data/sparse/Plate_50K/PlateMat_D.mat");
